...
@RestController
@RequestMapping("/api/statistics-kafka")
public class StatisticsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(StatisticsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public StatisticsKafkaResource(KafkaProperties kafkaProperties) {
